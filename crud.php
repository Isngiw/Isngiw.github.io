  ...
  <body>
    ...
    <div class="modal fade" id="ratesummary" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Reviewer List </h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <table id="datatableid" class="table table-bordered table-dark">
                <thead>
                  <tr>
                    ...
                    <th scope="col"> Reviewed Movie</th>
                  </tr>
                </thead>
                <?php
                  if($result)
    ...
    <div class="container" style="width: 400px !important;   margin-top: -421px ;margin-left: 1098px; " >
      ...
      <div class="card">
        <div class="card-body" style="height: 348px !important;">
          <?php                 
            $nsql="SELECT DISTINCT `title`, `stars` from view3 WHERE stars>2 limit 5";
            $result=mysqli_query($db_conn,$nsql);
            ?>
          <table id="datatableid" class="table table-bordered table-dark">
            <thead>
    ...
    <div class="fluid" >
      ...
      <div class="card">
        <div class="card-body">
          ...
          <a href="cindex.php">  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rategraph">
          VIEW RATING SUMMARY
          </button></a>
        </div>
      </div>
      <div class="card">
        <div class="card-body">
          <?php
            $nsql="SELECT * from `movie` ORDER BY mID ASC ";
            $result=mysqli_query($db_conn,$nsql);
            ?>
          <table id="datatableid" class="table table-bordered table-dark">
            <thead>
